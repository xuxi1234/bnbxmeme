...
contract BNBXRewardVaultV3Test {
    ...
    RewardAssetV3Mock internal rewardToken;
    RewardAssetV3Mock internal lpToken;
    BNBXRewardVaultV3 internal holderVault;
    BNBXRewardVaultV3 internal lpVault;

    function setUp() public {
        rewardToken = new RewardAssetV3Mock();
        lpToken = new RewardAssetV3Mock();
        holderVault = new BNBXRewardVaultV3(
