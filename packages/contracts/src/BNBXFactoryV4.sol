...
contract BNBXFactoryV4 {
    ...
    function _deployVanityToken(
        ...
        bytes32 vanitySalt
    ) internal returns (BNBXTokenV4 token) {
        ...
        token = new BNBXTokenV4{ salt: vanitySalt }(name, symbol, address(this));
    }
